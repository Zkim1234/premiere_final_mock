...
const slides = [
  {
    ...
    description:
      "Up to an Additional 40% Off* Offers valid from: 27-03-2025 | Valid to: 01-04-2025",
  },
  {
      ...
      <div className={style.carouselHeader}>
        ...
        <div className={style.subtitleContainer}>
          <h5 className={style.carouselSubtitle}>
            Find the best deals on food!
          </h5>
          <h5
            className={style.seeMore}
            onClick={() => router.push("/sales_page/sales-food")}
          >
            see more...
          </h5>
        </div>
  ...
  return (
    <div className={style.carouselWrapper}>
      <div className={style.carouselHeader}>
        ...
        <div className={style.subtitleContainer}>
          <h5 className={style.carouselSubtitle}>
            See what other deals you can get!
          </h5>
          <h5
            className={style.seeMore}
            onClick={() => router.push("/sales_page/sales-food")}
